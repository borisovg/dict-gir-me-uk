...
angular.module('edit-word', ['cfg.noDebug'])
    ...
    .controller('editWordCtrl', ['$scope', 'classSvc', 'genderSvc', 'typeSvc', 'wordSvc', function ($scope, classSvc, genderSvc, typeSvc, wordSvc) {
        ...
        $scope.symbols = {
            ...
            Latin: {
                a: ['á', 'à', 'ă', 'ắ', 'ā', 'ā́', 'ä', 'ą', 'ą́', 'a̋', 'ȁ', 'ã', 'ā̆'],
                e: ['é', 'è', 'ĕ', 'ė', 'Ė', 'ė̃', 'ė́', 'ė̀', 'ē', 'ḗ', 'ë', 'ě','ę', 'ę́', 'e̋', 'ȅ', 'ẽ', 'ǝ', 'ē̆'],
                i: ['í', 'ì', 'ĭ', 'ī', 'ï', 'į', 'i̋', 'ȉ', 'ĩ', 'i̯', 'ī̆'],
                o: ['ó', 'ò', 'ŏ', 'ō', 'ṓ', 'ö', 'ǫ', 'ǫ́', 'ő', 'ȍ', 'õ', 'ō̆'],
                u: ['ú', 'ù', 'ŭ', 'ū', 'ū́', 'ü', 'ų', 'ų́', 'ű', 'ȕ', 'ũ', 'u̯', 'ū̆'],
                y: ['ý', 'ỳ', 'y̋', 'y̏'],
                æ: ['æ', 'Æ'],
                c: ['c̀', 'ć', 'č', 'Č'],
                d: ['ḍ', 'ð'],
